...
d_max <- function(x, y, w, span) {
  ...
  if (j<50) {
    ...
    index_max_all_maj <- subset(index_max_all, index_max_all<=round(max(index(x)/1.5)))
    #not too far away #mod 65 to 15
    index_max_all_maj <- subset(index_max_all_maj, index_max_all<=(peaks$i+15))
    #not too far back
  ...
  if (j>50) { #mod from 115 to 50 to 55
    #not too far away
    index_max_all_maj <- subset(index_max_all, index_max_all<=(peaks$i+15)) #mod from 15 to 10 to 8
    #not too far back
    index_max_all_maj <- subset(index_max_all_maj, index_max_all_maj>=(peaks$i-2))
  }
  ...
  if (j>90) { #mod from 115 to 50 to 55 to 20
    #not too far away
    index_max_all_maj <- subset(index_max_all, index_max_all<=(peaks$i+10)) 
    #not too far back
    index_max_all_maj <- subset(index_max_all_maj, index_max_all_maj>=(peaks$i-2))
  }
